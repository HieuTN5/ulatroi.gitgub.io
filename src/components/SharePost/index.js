...
// import Gallery from 'react-fb-image-grid';
...
const SharePost = (props) => {
  ...
  const renderPostSource = ({ postType, postFile, postLinkTitle, postLinkContent, postLink, postYoutube, postFileName, fund_data, postLinkImage, post_share }) => {
    let result;
      ...
      <div className="mt-5 mb-5 flex items-end justify-center gap-4  max-w-2xl border-slate-300 rounded-lg border">
        <div className=" rounded-lg bg-white">
          ...
          <div className='px-4 pb-4'>
            {renderPostSource({ postType, postFile, postLinkTitle, postLinkContent, postLink, postYoutube, postFileName, fund_data, postLinkImage, post_share })}
          ...
          <div className='p-4'>
            ...
            <span className="inline-block text-gray-500 text-xs leading-3">
              ...
              {postType === POST_TYPE.POST && fund_data && <span>Tạo sự kiện ủng hộ -</span>} 
